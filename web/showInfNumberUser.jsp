...
<html>
    ...
    <body>
        <%HotelNumber min = (HotelNumber) request.getAttribute("minPrice");%>
        <%HotelNumber max = (HotelNumber) request.getAttribute("maxPrice");%>
                                ...
                                <center>
                                    ...
                                    <table border="0" cellpadding="5" cellspacing="5">
                                        <tr>
                                            ...
                                            <th><fmt:message bundle="${msgs}" key="number.minPrice"/></th>
                                            <th><fmt:message bundle="${msgs}" key="number.maxPrice"/></th>
                                        </tr>
                                        <td><%out.println(min.getType().getType());%></td>
                                        <td><%
                                            if (min.getType().getDescription() == null) {%>
                                                <fmt:message bundle="${msgs}" key="no.info"/>
                                           <% } else {
                                                out.println(min.getType().getDescription());
                                        }%></td>
                                        <td><%out.println(min.getPricePerDay() + "y.e.");%></td>
                                        <td><%out.println(max.getPricePerDay() + " y.e.");%></td>
                                    </table>
                                </center>
